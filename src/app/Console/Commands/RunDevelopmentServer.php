...
class RunDevelopmentServer extends Command
{
    /**
     ...
     * @var string
     */
    protected $description = 'Serve the application on the PHP development server using default project port defined on .env file';
    ...
    protected function port()
    {
        ...
        $port = config('customcommands.default_port');
